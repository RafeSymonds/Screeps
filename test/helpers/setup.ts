...
globalAny.FIND_EXIT = 10;
globalAny.FIND_EXIT_TOP = 1;
globalAny.FIND_EXIT_RIGHT = 3;
globalAny.FIND_EXIT_BOTTOM = 5;
globalAny.FIND_EXIT_LEFT = 7;
globalAny.LOOK_STRUCTURES = "structure";
globalAny.LOOK_CONSTRUCTION_SITES = "constructionSite";
globalAny.LOOK_TERRAIN = "terrain";
globalAny.TOP = 1;
globalAny.TOP_RIGHT = 2;
globalAny.RIGHT = 3;
globalAny.BOTTOM_RIGHT = 4;
globalAny.BOTTOM = 5;
globalAny.BOTTOM_LEFT = 6;
globalAny.LEFT = 7;
globalAny.TOP_LEFT = 8;
