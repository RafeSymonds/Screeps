...
- 2026-03-18: Refactored `backlog.md` into the four streams requested by `technical-architect` (Spawn/Body, Remote Mining, Hauling/Throughput, Room Growth) to unblock parallel work and reduce regression risk. Decomposed broad items into 12 specific, low-risk tasks with clear scope, rationale, and affected modules.
